...
public class CuzEditText extends EditText {
	
	private Context mContext;
	private AttributeSet mAttrs;
	
	public CuzEditText(Context context) {
		super(context);
		mContext = context;
		setIncludeFontPadding(false);
	}

	public CuzEditText(Context context, AttributeSet attrs) {
		super(context, attrs);
		mContext = context;
		mAttrs = attrs;
	...
	public CuzEditText(Context context, AttributeSet attrs, int defStyle) {
