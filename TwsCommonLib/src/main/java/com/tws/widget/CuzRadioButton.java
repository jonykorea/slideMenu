...
public class CuzRadioButton extends RadioButton {

	private Context mContext;
	private AttributeSet mAttrs;

	public CuzRadioButton(Context context) {
		super(context);
		mContext = context;
		setIncludeFontPadding(false);
	}

	public CuzRadioButton(Context context, AttributeSet attrs) {
		super(context, attrs);
		mContext = context;
		mAttrs = attrs;
	...
	public CuzRadioButton(Context context, AttributeSet attrs, int defStyle) {
