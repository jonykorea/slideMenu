 ...
 */
public class GeofenceClient implements
    ...
    public static final int SET_GEOFENCE = 100;
    ...
    public GeofenceClient(Context context, Handler handler) {

        LOG.d("GeofenceClient");
    ...
    {
        LOG.d("GeofenceClient getConnect");
    ...
    {
        LOG.d("GeofenceClient disconnect");
    ...
    {
        LOG.d("GeofenceClient startGeofence");
    ...
    public void stopGeofence()
    {
        ...
        LOG.d("GeofenceClient stopGeofence");
    ...
    public void onConnected(Bundle connectionHint) {
        ...
        LOG.d("GeofenceClient onConnected");
    ...
    public void onConnectionFailed(ConnectionResult result) {
        ...
        // onConnectionFailed.
        callbackHandler.sendEmptyMessage(LocationDefines.GMS_CONNECT_FAIL);
        LOG.d("GeofenceClient Connection failed: ConnectionResult.getErrorCode() = " + result.getErrorCode());
    }
    ...
    public void onConnectionSuspended(int cause) {
        ...
        LOG.d("GeofenceClient Connection suspended");
        callbackHandler.sendEmptyMessage(LocationDefines.GMS_CONNECT_FAIL);
        //mGoogleApiClient.connect();
    }
    ...
    public void onResult(Status status) {
        if (status.isSuccess()) {
            ...
            LOG.d("onResult " + status.isSuccess());
    ...
    public void populateGeofenceList() {
        for (Map.Entry<String, LatLng> entry : Constants.GEOFENCE_AREA.entrySet()) {
