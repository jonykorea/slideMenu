...
//		Log.i("GlobalParcelable","Constructor: " + this.getClass().getSimpleName() + "; In parcel: " + className);
	...
	public static final Creator<GlobalParcelable> CREATOR = new Creator<GlobalParcelable>() {
...
//				Log.e("GlobalParcelable", "Could not write field to parcel: " + " (" + field.getType().toString() + ")");
	...
	private static Field[] getAllFields(GlobalParcelable model){
		List<Field> listFields = getAllFieldsList(model.getClass());
	...
	private static List<Field> getAllFieldsList(Class clazz) {
	    ...
	    if(superClazz != null && superClazz!=Object.class
	    		&& superClazz!=GlobalParcelable.class){
	        fields.addAll(getAllFieldsList(superClazz));
	    }
	    return fields;
	}
